CREATE TABLE IF NOT EXISTS `dataset_metadata` (
    `repository` VARCHAR, -- github repository, ex: https://github.com/DominicTWHV/CTI-DB-DUMP/ | If using a txt dataset, the url will be stored if the dataset isn't on github.
